...
class ClasificadorIntencion:
    ...
    def clasificar(self, mensaje: str) -> Dict:
        ...
        prompt_clasificar = self._crear_prompt_clasificacion(mensaje_lower, clasificaciones_posibles)

        # Aquí llamarías a tu API de LLM
        respuesta_clasificar = self._llamar_llm(prompt_clasificar)
    ...
    def _procesar_respuesta(self, respuesta_llm: str, mensaje_original: str, clasificaciones_posibles: list) -> Dict:
    ...
    def _extraer_json_de_respuesta(self, respuesta: str) -> Optional[Dict]:
